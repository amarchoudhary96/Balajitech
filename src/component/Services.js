        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
          {items.map(item => (
            <motion.div
              ...
              className={`cursor-pointer sm:w-[250px] sm:h-[200px] w-[150px] h-[150px] p-6 bg-blue-400 shadow-2xl rounded-md hover:bg-gray-200  transition duration-300 ${
                animate ? 'animate__animated animate__flipInX -webkit-animate__animated -webkit-animate__flipInX' : ''
              }`}
            >
